...
const englishMessages = {
  ...
  "exports.label": "Export streams",
  "exports.downloadCsv": "Download CSV",
  "exports.downloadJson": "Download JSON",
  "exports.exporting": "Preparing...",
  "exports.error": "Could not export streams: {{message}}",
  ...
  "system.unavailable": "Service unavailable",
  "statusPage.eyebrow": "Service monitoring",
  "statusPage.title": "System status",
  "statusPage.description": "Check the services required to run this self-hosted installation.",
  "statusPage.services": "Services",
  "statusPage.loading": "Checking services...",
  "statusPage.checkedAt": "Checked {{date}}",
  "statusPage.refresh": "Refresh",
  "statusPage.refreshing": "Refreshing...",
  "statusPage.operational": "Operational",
  "statusPage.unavailable": "Unavailable",
  "statusPage.backend": "Backend API",
  "statusPage.database": "PostgreSQL",
  "statusPage.media": "MediaMTX",
  "statusPage.error": "Could not load service status: {{message}}",
  ...
  "errors.loadSystemStatus": "The service status could not be loaded.",
  "errors.exportStreams": "The streams could not be exported.",
...
const russianMessages: Record<TranslationKey, string> = {
  ...
  "exports.label": "Экспорт трансляций",
  "exports.downloadCsv": "Скачать CSV",
  "exports.downloadJson": "Скачать JSON",
  "exports.exporting": "Подготовка...",
  "exports.error": "Не удалось экспортировать трансляции: {{message}}",
  ...
  "system.unavailable": "Сервис недоступен",
  "statusPage.eyebrow": "Мониторинг сервисов",
  "statusPage.title": "Статус системы",
  "statusPage.description": "Проверьте сервисы, необходимые для работы этой self-hosted установки.",
  "statusPage.services": "Сервисы",
  "statusPage.loading": "Проверка сервисов...",
  "statusPage.checkedAt": "Проверено: {{date}}",
  "statusPage.refresh": "Обновить",
  "statusPage.refreshing": "Обновление...",
  "statusPage.operational": "Работает",
  "statusPage.unavailable": "Недоступен",
  "statusPage.backend": "Backend API",
  "statusPage.database": "PostgreSQL",
  "statusPage.media": "MediaMTX",
  "statusPage.error": "Не удалось загрузить статус сервисов: {{message}}",
  ...
  "errors.loadSystemStatus": "Не удалось загрузить статус сервисов.",
  "errors.exportStreams": "Не удалось экспортировать трансляции.",
