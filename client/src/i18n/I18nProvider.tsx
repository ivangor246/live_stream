...
const englishMessages = {
  ...
  "auth.loginDescription": "Use your local administrator account to continue.",
...
const russianMessages: Record<TranslationKey, string> = {
  ...
  "auth.loginDescription": "Используйте локальный аккаунт администратора, чтобы продолжить.",
