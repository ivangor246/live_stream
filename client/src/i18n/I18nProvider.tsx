...
const englishMessages = {
  ...
  "password.description": "Changing your password signs out your other devices.",
  "password.currentLabel": "Current password",
  "password.newLabel": "New password",
  "password.confirmationLabel": "Confirm new password",
  "password.submit": "Change password",
  "password.changing": "Changing password...",
  "password.success": "Password changed. Other sessions have been signed out.",
  "password.mismatch": "The new passwords do not match.",
  "accounts.title": "Accounts",
  "accounts.description": "Review dashboard accounts and remove access when it is no longer needed.",
  "accounts.loading": "Loading accounts...",
  "accounts.none": "There are no accounts yet.",
  "accounts.role.admin": "Administrator",
  "accounts.role.operator": "Operator",
  "accounts.role.viewer": "Viewer",
  "accounts.roleLabel": "Role",
  "accounts.created": "Created {{date}}",
  ...
  "accounts.enabling": "Enabling...",
  "accounts.delete": "Delete",
  "accounts.deleting": "Deleting...",
  "accounts.confirmDisable": "Disable {{username}}? Their current sessions will end.",
  "accounts.confirmRole": "Change {{username}} to {{role}}? Their permissions take effect immediately.",
  "accounts.confirmDelete": "Delete {{username}}? This permanently removes the account.",
  ...
  "calendar.openDate": "Open date picker {{date}}",
  "calendar.openTime": "Open time picker {{time}}",
  "calendar.previousMonth": "Previous month",
  "calendar.selectDate": "Select date",
  "calendar.selectDateTime": "Select date and time",
  ...
  "streams.plannedStartLabel": "Planned start (optional)",
  "streams.plannedStartLabelCompact": "Start (optional)",
  ...
  "streams.plannedStart": "Planned start",
  "streams.notScheduled": "Not scheduled",
  "viewerName.title": "Join the stream",
  "viewerName.description": "Enter the name shown while you are connected.",
  "viewerName.label": "Your name",
  "viewerName.placeholder": "Enter your name",
  "viewerName.join": "Join stream",
  ...
  "stream.plannedStart": "Planned start: {{date}}",
  ...
  "validation.plannedStart": "Enter a valid planned start time.",
  "validation.viewerNameRequired": "Enter your name to join the stream.",
  "validation.viewerNameMax": "Your name must contain at most 80 characters.",
  ...
  "errors.changePassword": "The password could not be changed.",
  "errors.loadAccounts": "The accounts could not be loaded.",
  "errors.updateAccount": "The account could not be updated.",
  "errors.deleteAccount": "The account could not be deleted.",
  ...
  "errors.AUTH_INVALID_CURRENT_PASSWORD": "The current password is incorrect.",
  ...
  "errors.AUTH_SELF_DEACTIVATION": "You cannot disable your own account.",
  "errors.AUTH_USER_NOT_FOUND": "This account was not found.",
  "errors.AUTH_USER_ACTIVE": "Disable this account before deleting it.",
  "errors.AUTH_SELF_DELETION": "You cannot delete your own account.",
...
const russianMessages: Record<TranslationKey, string> = {
  ...
  "password.description": "После смены пароля на других устройствах потребуется войти заново.",
  "password.currentLabel": "Текущий пароль",
  "password.newLabel": "Новый пароль",
  "password.confirmationLabel": "Повторите новый пароль",
  "password.submit": "Сменить пароль",
  "password.changing": "Смена пароля...",
  "password.success": "Пароль изменён. Остальные сессии завершены.",
  "password.mismatch": "Новые пароли не совпадают.",
  "accounts.title": "Аккаунты",
  "accounts.description": "Просматривайте аккаунты панели и отключайте доступ, когда он больше не нужен.",
  "accounts.loading": "Загрузка аккаунтов...",
  "accounts.none": "Аккаунтов пока нет.",
  "accounts.role.admin": "Администратор",
  "accounts.role.operator": "Оператор",
  "accounts.role.viewer": "Зритель",
  "accounts.roleLabel": "Роль",
  "accounts.created": "Создан {{date}}",
  "accounts.current": "Текущий аккаунт",
  "accounts.active": "Активен",
  "accounts.disabled": "Отключён",
  "accounts.disable": "Отключить",
  "accounts.disabling": "Отключение...",
  "accounts.enable": "Включить",
  "accounts.enabling": "Включение...",
  "accounts.delete": "Удалить",
  "accounts.deleting": "Удаление...",
  "accounts.confirmDisable": "Отключить аккаунт {{username}}? Его активные сессии будут завершены.",
  "accounts.confirmRole": "Изменить роль {{username}} на «{{role}}»? Права изменятся сразу.",
  "accounts.confirmDelete": "Удалить аккаунт {{username}}? Это действие нельзя отменить.",
  ...
  "calendar.confirm": "Готово",
  "calendar.nextMonth": "Следующий месяц",
  "calendar.openDate": "Открыть календарь {{date}}",
  "calendar.openTime": "Открыть выбор времени {{time}}",
  "calendar.previousMonth": "Предыдущий месяц",
  "calendar.selectDate": "Выберите дату",
  "calendar.selectDateTime": "Выберите дату и время",
  "calendar.selectTime": "Выберите время",
  ...
  "streams.plannedStartLabel": "Планируемое начало (необязательно)",
  "streams.plannedStartLabelCompact": "Начало (необязательно)",
  ...
  "streams.plannedStart": "Планируемое начало",
  "streams.notScheduled": "Не запланировано",
  "viewerName.title": "Подключиться к трансляции",
  "viewerName.description": "Укажите имя, которое будет использоваться во время подключения.",
  "viewerName.label": "Ваше имя",
  "viewerName.placeholder": "Введите имя",
  "viewerName.join": "Подключиться",
  ...
  "stream.plannedStart": "Планируемое начало: {{date}}",
  ...
  "connection.reconnecting": "Повторное подключение...",
  ...
  "validation.plannedStart": "Введите корректное время планируемого начала.",
  "validation.viewerNameRequired": "Введите имя, чтобы подключиться к трансляции.",
  "validation.viewerNameMax": "Имя должно содержать максимум 80 символов.",
  ...
  "errors.changePassword": "Не удалось сменить пароль.",
  "errors.loadAccounts": "Не удалось загрузить аккаунты.",
  "errors.updateAccount": "Не удалось изменить аккаунт.",
  "errors.deleteAccount": "Не удалось удалить аккаунт.",
  ...
  "errors.AUTH_INVALID_CURRENT_PASSWORD": "Текущий пароль указан неверно.",
  ...
  "errors.AUTH_SELF_DEACTIVATION": "Нельзя отключить собственный аккаунт.",
  "errors.AUTH_USER_NOT_FOUND": "Этот аккаунт не найден.",
  "errors.AUTH_USER_ACTIVE": "Перед удалением отключите этот аккаунт.",
  "errors.AUTH_SELF_DELETION": "Нельзя удалить собственный аккаунт.",
